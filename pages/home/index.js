        ...
        <Layout>
            <section className='flex gap-4'>
                <Card className='w-full'>
                    ...
                    <p className='text-gray-800 text-xl'>5,266 Pelanggan<span className='text-red-500 bg-red-100 p-1 font-bold rounded-full text-xs'>-5%</span></p>
                ...
                <Card className='w-full'>
                    ...
                    <p className='text-gray-800 text-xl'>Rp.1.500.000 / Pelanggan<span className='text-green-500 bg-green-100 p-1 font-bold rounded-full text-xs'>+8%</span></p>
                ...
                <Card className='w-full'>
                    ...
                    <p className='text-gray-800 text-xl'>7 / Pelanggan <span className='text-green-500 bg-green-100 p-1 font-bold rounded-full text-xs'>+4%</span></p>
